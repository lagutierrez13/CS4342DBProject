...
<body>
    <div style="margin-top: 20px" class="container">
        ...
        if (isset($_POST['Submit'])) {
            ...
            $queryAdvisor  = "INSERT INTO employee (Eid,Ename,Eemail,Epassword)
                        VALUES ('" . $eid . "', '" . $ename . "', '" . $eemail . "', '" . $epassword . "');";

            $queryAdvisor2  = "INSERT INTO advisor (Eid)
                        VALUES ('" . $eid . "');";

            // The query sent to the DB can be printed by not commenting the following row
            //echo $queryStudent;
            if (($conn->query($queryAdvisor) === TRUE) and ($conn->query($queryAdvisor2) === TRUE)) {
