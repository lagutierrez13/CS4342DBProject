...
if (isset($_GET['Sid'])) {
    ...
    echo "No student id received on request at update_advisor get";
    die();
}
?>
...
<body>
    <div style="margin-top: 20px" class="container">
        ...
        <form action="change_advisor.php" method="post">
            <input type="hidden" name="Sid" id="Sid" value="<?php echo $row['Sid'] ?>">
            <div class="form-group">
                <label for="Eid">Advisor ID</label>
                <input class="form-control" type="text" id="Eid" name="Eid" value="<?php echo $row['Eid'] ?>">
            </div>
            <div class="form-group">
